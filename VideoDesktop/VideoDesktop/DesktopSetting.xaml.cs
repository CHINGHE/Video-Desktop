...
namespace VideoDesktop
{
    ...
    /// </summary>
    public partial class DesktopSetting : Window
    {
        ...
        System.Windows.Forms.Screen _screen;
        int _screenIndex;
        ...
        void Play_()
        {
            ...
            this.m_play.Header = btnPlay.Content = "暂停";
        ...
        void Pause_()
        {
            ...
            this.m_play.Header = btnPlay.Content = "播放";
        }
        ...
        void OpenFile(string path)
        {
            ...
            else if (uri.Scheme == "file")
            {
                if (!File.Exists(path))
                {
                    System.Windows.MessageBox.Show($"找不到文件 \"{path}\"", Constant.ProjectName);
                    return;
                }
        ...
        void OpenWeb(string url)
        {
            ...
            {
                System.Windows.MessageBox.Show("打开网页功能需要 WebView2 支持。请在托盘图标找到 DreamScene2 然后右键菜单，依次点击 [打开 URL] > [安装 WebView2...] 安装。", Constant.ProjectName);
                return;
            }
